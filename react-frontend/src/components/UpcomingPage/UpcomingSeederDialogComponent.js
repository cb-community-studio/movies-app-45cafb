...
import seederData from "./upcoming.seeder.json";
...
const UpcomingSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(UpcomingSeederDialogComponent);
