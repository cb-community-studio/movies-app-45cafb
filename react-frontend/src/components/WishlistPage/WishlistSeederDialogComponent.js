...
import seederData from "./wishlist.seeder.json";
...
const WishlistSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(WishlistSeederDialogComponent);
